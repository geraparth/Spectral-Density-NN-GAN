...
def getSavePath():
    ...
    dir_name = dir_name + 'RSGAN_{}_dlr{}_glr{}_diter{}_giter{}_b1{}_b2{}_featureNum{}_bottleneck{}_batchsize{}_norm{}'.format(
        args.dataset.upper(), args.d_lr, args.g_lr, args.d_freq, args.g_freq, args.beta1, args.beta2, 
        args.num_features, args.bottleneck, args.batch_size, args.norm)
...
def train():
    ...
    for i in range(1, args.num_iters+1):
        ...
        for _ in range(args.g_freq):
            try:
                x = next(data_iter)[0].to(device).float()
...
if __name__=='__main__':
    ...
    parser.add_argument('--structure', type=str, default='resnet', choices=['resnet', 'dcgan'])
