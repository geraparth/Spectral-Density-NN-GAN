...
def tridiag_to_eigv(nodes, evecs):
...
def tridiag_to_density(eig_vals, eig_vecs, sigma_squared=1e-5, grid_len=10000):
    ...
    """
    eig_vals, all_weights = tridiag_to_eigv(eig_vals, eig_vecs)
#     print(eig_vals, all_weights)
